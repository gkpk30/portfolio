  ...
  return (
    ...
    >
      ...
      <div className=" max-w-[1000px] mx-auto  px-8 lg:px-20 flex flex-col justify-center h-full " >
        ...
        <h1 className="text-4xl sm:text-7xl font-bold text-slate-300">WE BRING IT</h1>
        <h2 className="text-4xl sm:text-7xl font-bold text-gray-500">ALL TOGETHER</h2>
        <p className="text-gray-500 max-w-2xl py-4  " >I specialize in building responsive full-stack web applications.</p>
        <div>
        <Link  to="work" spy={true} smooth={true} duration={500} >
            <button className="group  text-white border-2 px-4 py-4 my-8 flex items-center hover:bg-pink-600 hover:border-pink-600" >  View Work 
