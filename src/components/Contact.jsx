    ...
    <div name='contact' className="w-full h-screen bg-[#0a192f] flex justify-center items-center p-4 text-gray-300">
        <form action="" className="flex flex-col max-w-[1000px] w-full">
            <div className="pb-8">
                ...
                <p className="text-gray-300 py-4" >Submit the form below or send an email to - gnkdevelopment@gmail.com</p>
            </div>
            ...
            <textarea className="bg-[#ccd6f6] p-2 text-black" placeholder="Message"  name="message" cols="38" row="10" />
            <button className="border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 my-8 mx-auto flex items-center">Send</button>
        </form>
    </div>
  )
}
